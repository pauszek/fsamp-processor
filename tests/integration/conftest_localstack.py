...
# =============================================================================
"""
Integration test fixtures using LocalStack (real Docker container).

Use these fixtures for tests that need real AWS behavior:
- testcontainers-python for LocalStack lifecycle
- Real AWS SDK calls (not mocked)
- SQS message polling behavior
- DynamoDB streams

Usage:
    @pytest.mark.integration
    def test_something(localstack_s3_client, localstack_bucket):
        ...
...
# Module-scoped container for reuse across tests
